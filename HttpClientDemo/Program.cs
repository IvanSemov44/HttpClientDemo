...
namespace HttpClientDemo
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                using (var stream = client.GetStream())
                {
                    ...
                    string html = $"<h1>Hello from IvanServer {DateTime.Now}</h1>";

                    string response = "HTTP/1.1 200 OK" + NewLine +
                        "Server: IvanServer 2021" + NewLine +
        ...
        private static async Task ReadData()
        {
            ...
            string url = "https://softuni.bg/trainings/3164/csharp-web-basics-september-2020#lesson-18193";
